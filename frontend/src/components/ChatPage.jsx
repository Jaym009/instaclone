...
const ChatPage = () => {
    ...
    const sendMessageHandler = async (receiverId) => {
        try {
            const res = await axios.post(`https://instaclone-o3w0.onrender.com/api/v2/message/send/${receiverId}`, {textMessage}, {
                headers:{
                ...
                selectedUser ? (
                    <section className='flex-1 border-l-gray-300 flex flex-col h-full'>
                        ...
                        <div className='flex items-center p-4 border-t border-t-gray-300'>
                            <Input value={textMessage} onChange={(e) => setTextMessage(e.target.value)} className='flex-1 mr-2 focus-visible:ring-transparent' placeholder='Messages...' type='text' />
                    ...
                    <div className='flex flex-col items-center justify-center mx-auto'>
                        ...
                        <h1 className='font-mediumtext-xl'>Your Messages</h1>
