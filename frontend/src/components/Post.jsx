...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://instaclone-o3w0.onrender.com/api/v2/post/${post._id}/${action}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`https://instaclone-o3w0.onrender.com/api/v2/post/${post._id}/comment`, { text }, {
                headers: {
    ...
    const deletePostHandler = async () => {
        try {
            const res = await axios.delete(`https://instaclone-o3w0.onrender.com/api/v2/post/delete/${post._id}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const bookMarkHandler = async () => {
        try {
            const res = await axios.get(`https://instaclone-o3w0.onrender.com/api/v2/post/${post._id}/bookmark`, {withCredentials:true})
            if(res.data.success){
                toast.success(res.data.message)
            }
        } catch (error) {
